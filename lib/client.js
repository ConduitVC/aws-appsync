...
var AWSAppSyncClient = /** @class */ (function (_super) {
    ...
    function AWSAppSyncClient(_a, options) {
        var _b = _a === void 0 ? {} : _a, url = _b.url, region = _b.region, auth = _b.auth, conflictResolver = _b.conflictResolver, complexObjectsCredentials = _b.complexObjectsCredentials, _c = _b.cacheOptions, cacheOptions = _c === void 0 ? {} : _c, _d = _b.disableOffline, disableOffline = _d === void 0 ? false : _d;
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        newOptions = __assign({}, otherOptions, { optimisticResponse: doIt ? null : data, update: update }, (doIt ? { refetchQueries: refetchQueries } : {}), { context: context });
