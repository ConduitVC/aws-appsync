    ...
    OfflineLink.prototype.request = function (operation, forward) {
        ...
        return new apollo_link_1.Observable(function (observer) {
            ...
            var handle = forward(operation).subscribe({
                next: function (data) {
                    if (isMutation) {
                        var _a = cache_1.METADATA_KEY, cacheSnapshot = _this.store.getState()[_a].snapshot.cache;
                        var _b = operation.getContext(), cache = _b.cache, client = _b.AASContext.client;
...
exports.saveServerId = function (optimisticResponse, data) { return ({
    ...
    meta: { optimisticResponse: optimisticResponse },
    payload: { data: data },
}); };
var idsMapReducer = function (state, action, dataIdFromObject) {
    ...
    switch (type) {
        ...
        case actions.SAVE_SERVER_ID:
            var optimisticResponse = meta.optimisticResponse;
